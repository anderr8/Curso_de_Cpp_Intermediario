/*
    Implementação do algoritno de Kruskal

    Para detectar ciclos iremos utilizar o algoritmo Union-Find que detecta ciclos em grafos NÃO direcionados. 
*/
...
class Aresta{
    int vertice1, vertice2, peso; // vertice1 e 2 por padrão é privado
...
public:
    ...
    bool operator < (const Aresta& aresta2)const{
        return(peso < aresta2.peso); // Faz comparações crescentemente
    }
};
...
public:
    ...
    void kruskal(){
        ...
        for(int i = 0; i < size_arestas; i++){
            ...
            if(v1 != v2){
                // Se for diferentes é porque não forma ciclo
